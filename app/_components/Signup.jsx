          ...
          <div className=" flex flex-col md:w-[80%] w-[100%] ">
            ...
            <div className="flex flex-col justify-center md:mx-auto md:border-[gray] gap-16 md:border-[1px] rounded-xl px-5 py-8  md:w-[80%]">
              ...
              <div className="flex flex-col gap-4 justify-center items-center">
                <button className="flex gap-2 justify-center items-center rounded-lg border border-[gray] px-7 py-4 text-sm font-semibold text-white transition  hover:shadow-xl focus:outline-none focus:ring active:text-indigo-500 md:w-72 w-60">
